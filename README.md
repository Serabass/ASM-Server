...
| `ubuntu` | 78.1 MB | ~29 MB* | 10.9 KB | С базой Ubuntu |

### External (HTML через `incbin`)

| Base Image | Docker Image (несжатый) | Registry (сжатый) | Binary Size | Описание |
|------------|------------------------|-------------------|-------------|----------|
| `scratch` | 11.4 kB | ~1.8 KB* | 11.1 KB | Минимальный размер |
| `alpine` | 8.45 MB | ~3.7 MB* | 11.1 KB | С базой Alpine |
| `ubuntu` | 78.1 MB | ~29 MB* | 11.1 KB | С базой Ubuntu |

### File (HTML читается с диска)

| Base Image | Docker Image (несжатый) | Registry (сжатый) | Binary Size | Описание |
|------------|------------------------|-------------------|-------------|----------|
| `scratch` | 11.6 kB | ~1.9 KB* | 8.5 KB | Минимальный размер |
| `alpine` | 8.45 MB | ~3.7 MB* | 8.5 KB | С базой Alpine |
| `ubuntu` | 78.1 MB | 29.18 MB | 8.5 KB | С базой Ubuntu |

\* *Примерные значения на основе соотношения сжатия других образов*
